...
##=============ROOT==================
## /home/young/work/ruby/cordic root_file: 0 
##---------------------------------------
##=============sqrt==================
## sqrt file: 4 
ensure_lib		./prj_sqrt/
...
##==========================
###   vsim script
vsim -L prj_pkg -L prj_sqrt-L prj_XY-to-angle-L prj_sin-cos-L prj_test_angle_to_XY  -L 220model_ver -L altera_lnsim_ver -L altera_mf_ver -L altera_ver -L cycloneive_ver -L cycloneiii_ver -novopt 
